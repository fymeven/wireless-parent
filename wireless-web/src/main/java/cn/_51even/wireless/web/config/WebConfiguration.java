...
//        CusJwtAuthFilter httpBearerFilter = new CusJwtAuthFilter();
...
//        exclusions.add("/v2/*");
//        exclusions.add("/webjars/*");
//        exclusions.add("/swagger-ui.html/*");
//        exclusions.add("/actuator/*");
//        exclusions.add("/viewPage/*");
//        exclusions.add("/sysDict/*");
//        exclusions.add(WebSocketConstont.WS_ENDPOINT+"/*");
//        registrationBean.addInitParameter("exclusions", StringUtils.join(exclusions,","));
